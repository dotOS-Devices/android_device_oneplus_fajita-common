...
import org.dot.device.DeviceSettings.Constants;
import org.dot.device.DeviceSettings.DeviceSettings;
import org.dot.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.dot.device.DeviceSettings",
